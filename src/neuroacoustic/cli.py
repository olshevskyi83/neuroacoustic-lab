...
def analyze_cmd(
    ...
    rows = [
        ...
        ("voiced_ratio", str(fp.pitch.voiced_ratio)),
        ("pitch_confidence", str(fp.pitch.confidence)),
        ("harmonic_count", str(fp.harmonics.harmonic_count)),
        ("harmonic_density", str(fp.harmonics.harmonic_density)),
        ("harmonic_energy_fraction", str(fp.harmonics.harmonic_energy_fraction_estimate)),
        ("inharmonicity_estimate", str(fp.harmonics.inharmonicity_estimate)),
